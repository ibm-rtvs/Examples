 ...
 */
	public class COBOL_SignTrailingSeparate extends Function  {
		/**
		...
		public COBOL_SignTrailingSeparate(){
		}
		protected COBOL_SignTrailingSeparate(Function f1) {
			m_fInput = f1;
			NumberOfArguments = 1;
		}
		protected COBOL_SignTrailingSeparate(Function f1,Function f2) {
			m_fInput = f1;
			m_fLength = f2;
			NumberOfArguments = 2;
		}
		...
		public Function create(int size, Vector params) {
			if (size==1) return new COBOL_SignTrailingSeparate((Function) params.get(0));
			
			return new COBOL_SignTrailingSeparate((Function) params.get(0),(Function) params.get(1));
		}
		/**
		 * <P>On-line: <B>"Format the integer, padded with 0, sign in following"</B>
		 ...
		 * 
		 * <PRE> tags[number]=-18
		 * intLenghtOfTimmedString = COBOL_SignTrailingSeparate(tags[number]);</PRE>
		 * <P>will return 18-
		 *
		 * <PRE>tags[number]=-18
		 *  intLenghtOfTimmedString = COBOL_SignTrailingSeparate(tags[number],5);</PRE>
		 * <P>will return 00018-
		 * 
